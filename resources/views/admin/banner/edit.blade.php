...
<form enctype="multipart/form-data" role="form" method="post"
  action=" @if(isset($banner->id)) {{ route('banner.update',$banner->id) }} @else {{ route('banner.store') }} @endif ">
  {!! csrf_field() !!}
  <div class="row">
    <div class="col-md-12">
      <div class="box box-danger">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            <label>Ativo</label>
            <input class="" type="checkbox" name="active" @isset($banner)@if($banner->active) checked @endif @endisset
            data-toggle="toggle">
          </div>
          <div class="form-group">
            <label>Imagem</label>
