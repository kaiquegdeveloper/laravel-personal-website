...
<div class="box box-primary">
  ...
  <form enctype="multipart/form-data" role="form" method="post"
    action=" @if(isset($testimony->id)) {{ route('testimony.update',$testimony->id) }} @else {{ route('testimony.store') }} @endif ">
    {!! csrf_field() !!}
    ...
    <div class="box-body">
      <div class="form-group">
        <label>Nome</label>
        <input class="form-control" placeholder="Inserir Nome" type="text" name="name"
          value="@if(isset($testimony)){{$testimony->name}}@endif">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input class="form-control" name="company" type="text"
          value="@if(isset($testimony)){{$testimony->company}}@endif">
      </div>
      <div class="form-group">
        <label>Depoimento</label>
        <textarea class="form-control" rows="5" name="testimony"
          id="editor">@if(isset($testimony)){{$testimony->testimony}}@endif</textarea>
      </div>
      <div class="form-group">
        <label>Data</label>
