    ...
    <div class="col-md-6">
      <div class="box box-info">
        <div class="box-body">
          <div class="form-group">
            <label>CNPJ</label>
            <input class="form-control cnpj" id="cnpj" type="text" name="cnpj" placeholder="00.000.000/0000-00" value="@if(isset($configuration)){{$configuration->cnpj}}@endif" />
          </div>
          <div class="form-group">
    ...
    <div class="box box-info">
      ...
      <div class="box-body">
        <div class="form-group col-md-2">
          <label>CEP</label>
          <input id="cep" class="form-control" type="text" name="cep" value="@if(isset($configuration)){{$configuration->cep}}@endif" />
        </div>
